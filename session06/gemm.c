...
void
initRMatrix(size_t m, size_t n, double *A, ptrdiff_t incRowA, ptrdiff_t incColA)
{
    for (size_t j=0; j<n; ++j) {
        for (size_t i=0; i<m; ++i) {
...
//------------------------------------------------------------------------------
void
gemm_block(size_t m, size_t n, size_t k,
           const double *A, ptrdiff_t incRowA, ptrdiff_t incColA,
           const double *B, ptrdiff_t incRowB, ptrdiff_t incColB,
           double *C, ptrdiff_t incRowC, ptrdiff_t incColC)
{
           ...
           double *C, ptrdiff_t incRowC, ptrdiff_t incColC)
{
    ...
    size_t mb = mr==0 ? m/M_C-1 : m/M_C;
    size_t nb = nr==0 ? n/N_C-1 : n/N_C;
    size_t kb = kr==0 ? k/K_C-1 : k/K_C;
