#ifndef HPC_ULMBLAS_KERNELS_UGEMM_SSE_H
#define HPC_ULMBLAS_KERNELS_UGEMM_SSE_H 1
...
typename std::enable_if<BlockSize<double>::MR==4
                     && BlockSize<double>::NR==4
                     && std::is_convertible<Index,int64_t>::value,
         void>::type
...
#endif // HPC_ULMBLAS_KERNELS_UGEMM_SSE_H
